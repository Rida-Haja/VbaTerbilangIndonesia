...
Attribute TerbilangId.VB_Description = "Mengubah angka menjadi huruf (Terbilang). Support hingga 66 digit, desimal, dan minus."
Attribute TerbilangId.VB_ProcData.VB_Invoke_Func = " \n7"
